...
export default class EditMobilePaymentTO extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.put(`/mobilepaymentTo/update/${id}`, data).then((res) => {
            let path = "/viewmobilepayment"
            if (res.data.success) {
    ...
    componentDidMount() {
        ...
        axios.get(`/mobilepaymentTo/${id}`).then((res) => {
            if (res.data.success) {
                this.setState({
                    MobilePaymentCompanyID: res.data.post.MobilePaymentCompanyID,
                    MobileNumber: res.data.post.MobileNumber,
                    sixdigitNo: res.data.post.sixdigitNo,
                    AmountTOBECharged: res.data.post.AmountTOBECharged,
                ...
                <form>
                    ...
                    <div className="form-group" style={{ marginBottom: '15px' }}>
                        ...
                        <input type="text"
                            ...
                            placeholder="Mobile Payment Company ID"
