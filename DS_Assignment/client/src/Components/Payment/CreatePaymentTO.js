...
export default class CreatePaymentTO extends Component {
    ...
    onSubmit = (e) => {
        ...
        axios.post("/paymentTo/save", data).then((res) => {
            let path = "/emailsms"
            if (res.data.success) {
        ...
        return (
            <div >
                ...
                <div class="card" style={{width: '50rem', marginLeft:'22%'}}>
                    ...
                    <img src="https://th.bing.com/th/id/OIP.y8Z7DjFxYYyoSKF-dxb7zAHaDt?pid=ImgDet&rs=1"/>
                        <form>
                            <br />
                            <br />
                            <br />
